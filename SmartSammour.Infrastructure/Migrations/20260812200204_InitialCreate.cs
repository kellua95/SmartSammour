        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IncludeDomainAnalysis = table.Column<bool>(type: "bit", nullable: false),
                    IncludeHosting = table.Column<bool>(type: "bit", nullable: false),
                    IncludeDomainRegistration = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Plans",
                columns: new[] { "Id", "Description", "ExtraFee", "IncludeDomainAnalysis", "IncludeDomainRegistration", "IncludeHosting", "IsActive", "Name" },
                values: new object[,]
                {
                    { 1, "The most competitive pricing in Jordan for a professionally built product. You get clean, working software — done right, without the extras. Ideal if you know exactly what you need and want it delivered efficiently.", 0m, false, false, false, true, "Basic" },
                    { 2, "Domain requirement added to your requirement , built to a higher standard — plus domain setup, more thorough testing, and closer attention to detail throughout. The right choice if this product represents your business to real customers and needs to hold up under real use.", 200m, true, true, true, true, "Professional" },
                    { 3, "Everything in Professional, but as one complete system — a backend API, a website, and a mobile app, all built together and designed to work as a single product. Best for businesses that want to launch across web and mobile from day one, without stitching together separate builds later.", 500m, true, true, true, true, "Inclusive" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 300m, "Custom website, built to spec", "Website" },
                    { 2, 500m, "Cross-platform mobile app (iOS + Android)", "Mobile App" },
                    { 3, 700m, "Integrated website, mobile application, and backend/API solution", "Full Software Solution" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 250m, "E-commerce functionality", 1 },
                    { 2, 30m, "Extra page (each)", 1 },
                    { 3, 150m, "Admin dashboard", 1 },
                    { 4, 100m, "Push notifications", 2 },
                    { 5, 200m, "In-app purchases", 2 },
                    { 6, 150m, "Admin dashboard", 3 },
                    { 7, 300m, "E-commerce functionality", 3 }
                });
